...
public final class SelectCreatureBuddyBinding implements ViewBinding {
  ...
  private SelectCreatureBuddyBinding(@NonNull ConstraintLayout rootView, @NonNull FrameLayout Frame,
  ...
  public static SelectCreatureBuddyBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new SelectCreatureBuddyBinding((ConstraintLayout) rootView, Frame, attackEditText,
